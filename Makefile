...
TARGETNAME := libphystorqueryjni-linux.so
...
SOURCEFILES := common/JsCPPUtils/Common.cpp common/JsCPPUtils/Lockable.cpp common/JsCPPUtils/SmartPointer.cpp libphystorqueryjni/AppHandleManager.cpp libphystorqueryjni/Libphystorqueryjni.cpp libphystorqueryjni/LibphystorqueryLinuxImpl.cpp
EXTERNAL_LIBS := 
...
$(BINARYDIR)/Common.o : common/JsCPPUtils/Common.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/Lockable.o : common/JsCPPUtils/Lockable.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/SmartPointer.o : common/JsCPPUtils/SmartPointer.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/AppHandleManager.o : libphystorqueryjni/AppHandleManager.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/Libphystorqueryjni.o : libphystorqueryjni/Libphystorqueryjni.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)


$(BINARYDIR)/LibphystorqueryLinuxImpl.o : libphystorqueryjni/LibphystorqueryLinuxImpl.cpp $(all_make_files) |$(BINARYDIR)
	$(CXX) $(CXXFLAGS) -c $< -o $@ -MD -MF $(@:.o=.dep)
